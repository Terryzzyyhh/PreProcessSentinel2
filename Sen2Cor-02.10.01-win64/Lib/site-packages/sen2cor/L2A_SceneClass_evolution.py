...
class L2A_SceneClass(object):
    ...
    def L2A_CSHD_1(self, csd2):
        ...
        # if stats region represents at least 5% of data
        if (N_land_no_snow > (0.05 * N_data)) | (N_snow > (0.05 * N_data)):
    ...
    def L2A_CSHD_2_KLT_GAUSSIAN_BIS(self):
        ...
        if ((cloud_mask.sum() / KLTMask.sum()) < 0.95) & ((KLTMask.sum() / float(CM.size)) > 0.02):
