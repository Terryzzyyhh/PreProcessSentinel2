#!/usr/bin/env python
# includes patch for SIIMPC-1461 (line 3851 ff.)
# includes patch for SIIMPC-1520 (line 3885 ff.)
# includes patch for SIIMPC-1553 (line 5102 ff.)
# includes patch for SIIMPC-1659 (line 5455 ff.)
# includes patch for SCOR-17 (line 4968 ff.)
# includes patch for SCOR-28 (line 5038 ff.)

from numpy import *
import fnmatch

import cPickle as pickle
import sys, os, logging, inspect, glob
import ConfigParser
import glymur
...
def transform_wgs84_to_utm(lon, lat):
    ...
    wgs84_coordinate_system = utm_coordinate_system.CloneGeogCS()  # Clone ONLY the geographic coordinate system
    # create transform component
    if hasattr(utm_coordinate_system,'SetAxisMappingStrategy'):
        utm_coordinate_system.SetAxisMappingStrategy(osr.OAMS_TRADITIONAL_GIS_ORDER)
...
class L2A_Config(object):
    def __init__(self, logger, input_dir=False):
        self._ROI = None
        self._processorName = 'Sen2Cor'
        self._processorVersion = '02.10.01'
        self._processorDate = '2021.12.13' #'2021.09.08'
        self._productVersion = '14.9' #14.8
        ...
        self._productGeneratorDirectory = None
        self._datastrip_dir = None
        self._datastrip_dir_l1c = None
        self._metadata_l1c = None
        self._granule_dir = None
        ...
        if (input_dir):
            ...
            self._L2A_BOA_NEGATIVE_VALUES_LIST = zeros([13], dtype=uint16)
            ...
            self._PSD = None
            self._DOI = None
            self._sc_classic = None
            # ToDo: these values must be filled for the QI Statistics:
            ...
            self.water_vapour_retrieval_method = 'SEN2COR_APDA'
    ...
    def get_datastrip_dir(self):
        return self._datastrip_dir

    def get_datastrip_dir_l1c(self):
        return self._datastrip_dir_l1c

    def get_metadata_l1c(self):
        return self._metadata_l1c

    def get_granule_dir(self):
        return self._granule_dir
    ...
    def set_final_output_dir(self, value):
        self._final_output_dir = value

    def set_datastrip_dir(self, value):
        self._datastrip_dir = value

    def set_datastrip_dir_l1c(self, value):
        self._datastrip_dir_l1c = value

    def set_metadata_l1c(self, value):
        self._metadata_l1c = value

    def set_granule_dir(self, value):
        self._granule_dir = value
    ...
    def del_final_output_dir(self):
        del self._final_output_dir

    def del_datastrip_dir(self):
        del self._datastrip_dir

    def del_datastrip_dir_l1c(self):
        del self._datastrip_dir_l1c

    def del_metadata_l1c(self):
        del self._metadata_l1c

    def del_granule_dir(self):
        del _granule_dir
    ...
    def get_qi_report_scheme_2a(self):
        return self._qiReportScheme2a
    ...
    def set_qi_report_scheme_2a(self, value):
        self._qiReportScheme2a = value
    ...
    def del_qi_report_scheme_2a(self):
        del self._qiReportScheme2a
    ...
    def get_qltmask(self):
        return self._qltmask

    def set_qltmask(self, value):
        self._qltmask = value

    def del_qltmask(self):
        del self._qltmask
    ...
    def get_product_generator_directory(self):
        return self._productGeneratorDirectory
    ...
    def set_product_generator_directory(self, value):
        self._productGeneratorDirectory = value
    ...
    def del_product_generator_directory(self):
        del self._productGeneratorDirectory
    ...
    def get_l2a_qi_report_xml(self):
        return self._L2A_QI_REPORT_XML
    ...
    def set_l2a_qi_report_xml(self, value):
        self._L2A_QI_REPORT_XML = value
    ...
    def del_l2a_qi_report_xml(self):
        del self._L2A_QI_REPORT_XML
    ...
    def get_ncol_win(self):
        return self._ncol_win

    def get_nrow_win(self):
        return self._nrow_win
    ...
    def set_ncol_win(self, value):
        self._ncol_win = value

    def set_nrow_win(self, value):
        self._nrow_win = value


    def set_col0(self, value):
        self._col0 = value

    def set_row0(self, value):
        self._row0 = value
    ...
    def del_nrow_win(self):
        del self._nrow_win

    def del_ncol_win(self):
        del self._ncol_win
    ...
    def get_solze_noclip(self):
        return self._solze_noclip
    ...
    def set_solze_noclip(self, value):
        self._solze_noclip = value
    ...
    def del_solze_noclip(self):
        del self._solze_noclip
    ...
    final_output_dir = property(get_final_output_dir, set_final_output_dir, del_final_output_dir, "final_output_dir's docstring")
    datastrip_dir = property(get_datastrip_dir, set_datastrip_dir, del_datastrip_dir, "datastrip_dir's docstring")
    datastrip_dir_l1c = property(get_datastrip_dir_l1c, set_datastrip_dir_l1c, del_datastrip_dir_l1c, "datastrip_dir_l1c's docstring")
    metadata_l1c = property(get_metadata_l1c, set_metadata_l1c, del_metadata_l1c, "metadata_l1c xml's docstring")
    granule_dir = property(get_granule_dir, set_granule_dir, del_granule_dir, "granule_dir's docstring")
    ...
    aux_dir = property(get_aux_dir, set_aux_dir, del_aux_dir, "aux_dir's docstring")
    ...
    qltmask = property(get_qltmask, set_qltmask, del_qltmask, "qltmask's docstring")
    ...
    solze_noclip = property(get_solze_noclip, set_solze_noclip, del_solze_noclip, "solze_noclip's docstring")
    ...
    row0 = property(get_row0, set_row0, del_row0, "row0's docstring")
    col0 = property(get_col0, set_col0, del_col0, "col0's docstring")
    nrow_win = property(get_nrow_win, set_nrow_win, del_nrow_win, "nrow_win's docstring")
    ncol_win = property(get_ncol_win, set_ncol_win, del_ncol_win, "ncol_win's docstring")
    ...
    L2A_QI_REPORT_XML = property(get_l2a_qi_report_xml, set_l2a_qi_report_xml, del_l2a_qi_report_xml, "L2A_QI_REPORT_XML's docstring")
    ...
    productGeneratorDirectory = property(get_product_generator_directory, set_product_generator_directory, del_product_generator_directory,"productGeneratorDirectory's docstring")
    ...
    ROI = property(get_roi, set_roi, del_roi, "ROI's docstring")
    ...
    qiReportScheme2a = property(get_qi_report_scheme_2a, set_qi_report_scheme_2a, del_qi_report_scheme_2a, "qiReportScheme2a's docstring")
    ...
    PSD =  property(get_PSD, set_PSD, del_PSD, "PSD's docstring")
    DOI =  property(get_DOI, set_DOI, del_DOI, "DOI's docstring")
    ...
    def init_home_directory(self,operationMode):
        if operationMode == 'TOOLBOX':
            try:
                ...
                self._home = get_script_dir()
            self._configDir = os.path.join(get_script_dir(), 'cfg')
    ...
    def setSchemes(self):
        try:
            ...
            for i in range(psdLen):
                ...
                if (psd[i].attrib['PSD_Version']) == str(self.productVersion):
                    ...
                    if self.productVersion == float32(14.2):
                        # SIIMPC-1390: force L2A Product to convert to PSD Version 14.6
                        upScheme2a = upScheme2a.replace('14.2','14.6')
                        tileScheme2a = tileScheme2a.replace('14.2','14.6')
                        dsScheme2a = dsScheme2a.replace('14.2','14.6')
            ...
            self._qiReportScheme2a =  os.path.join(self.configDir,root.Common_Section.QI_Scheme.text + '.xsd')
    ...
    def configure_L2A_UP_metadata(self):
        ...
        if self.productVersion > float32(14.6):
             pi2a.PRODUCT_DOI = self.DOI
        us = str(self._UPgenerationTimestamp.microsecond)[:6]
        if '000000' in us:
            pi2a.GENERATION_TIME = strftime('%Y-%m-%dT%H:%M:%S',
                self._UPgenerationTimestamp.timetuple()) + 'Z'
        else:
            pi2a.GENERATION_TIME = strftime('%Y-%m-%dT%H:%M:%S.',
                self._UPgenerationTimestamp.timetuple()) + us + 'Z'
        qo = pi2a.Query_Options
        try:
            qo.Aux_List.attrib['productLevel'] = 'Level-2A'
        except:
            pass
        ...
        try:
            ...
            esacciWaterBodies = os.path.join(self.aux_dir, esacciWaterBodies)
            esacciLandCover = self.esacciLandCoverReference
            esacciLandCover = os.path.join(self.aux_dir, esacciLandCover)
            esacciSnowConditionDir = self.esacciSnowConditionDirReference
            esacciSnowConditionDir = os.path.join(self.aux_dir, esacciSnowConditionDir)
            item = xp.getTree('Auxiliary_Data_Info', 'LUT_List')
            item.append(lfn)
            ...
            auxinfo = xp.getNode('Auxiliary_Data_Info')
            item = objectify.Element('LUT_List')
            item.append(lfn)
    ...
    def getEntriesFromDatastrip(self):
        ...
        # Read radiometric offset from DS metadata file and save as a list
        # The list will allways be fully populated, even if the values aren't required, due to not appearing in bandIndex
        # @ Leonard: use this form to secure the Version Dependency.
        # make sure that the previous processing is performed if <= 14.6
        self.radio_add_offset_list = zeros(13, int16)
        if self.productVersion > float32(14.6):
            #self.radio_add_offset_list = zeros(13, int16)
            for index in range(13):
                offset = int16(pic.BOA_ADD_OFFSET_VALUES_LIST.BOA_ADD_OFFSET[index].pyval)
                self.radio_add_offset_list[index] = offset
    ...
    def create_L2A_Tile(self):
        ...
        if (os.path.exists(L2A_TILE_ID_)):
            ...
            self.L2A_QI_REPORT_XML = os.path.join(L2A_TILE_ID_, 'QI_DATA', 'L2A_QUALITY.xml')
        ...
        if self.L2A_TILE_MTD_XML is not None:
            try:
                ...
                try:
                    ...
                    us = str(dt.microsecond)[:6]
                    if '000000' in us:
                        ai.ARCHIVING_TIME = strftime('%Y-%m-%dT%H:%M:%S', dt.timetuple()) + 'Z'
                    else:
                        ai.ARCHIVING_TIME = strftime('%Y-%m-%dT%H:%M:%S.', dt.timetuple()) + us +'Z'
    ...
    def readPreferences(self):
        ...
        self.aux_dir = os.path.join(scriptDir, 'aux_data')
        # SIIMPC-889-1, end
        if self._resolution == 10:
        ...
        try:
            ...
            self.test_roi_scene = False
            if self.row0 == 'OFF':
                self.ROI = 'OFF'
            elif self.row0 == 'AUTO' and not self.scClassic:
                self.test_roi_scene = True
                self.ROI = 'AUTO'
            elif self.row0 == 'AUTO':
                self.ROI = 'AUTO'
            else:
                ...
                bottom = 10980
                outOfRange = False
                if self.row0 - self.nrow_win / 2.0 < left:
                    outOfRange = True
                elif self.col0 - self.ncol_win / 2.0 < top:
                    outOfRange = True
                elif self.row0 + self.nrow_win / 2.0 > right:
                    outOfRange = True
                elif self.col0 + self.ncol_win / 2.0 > bottom:
                    outOfRange = True
                if outOfRange:
                    self.logger.stream('Region of interest configuration is out of range, please correct. Application will terminate.')
                    return False
        except:
            self.parNotFound(subnode)

        par = node.Product_DOI
        if par is None: self.parNotFound(par)
        self.DOI = par.pyval

        par = node.PSD_Version
        if par is None: self.parNotFound(par)
        self.PSD = par.pyval
        ...
        par = node.Product_Generator
        if par is None: self.parNotFound(par)
        self.productGeneratorDirectory = par.text
        self.set_product_generator_directory(par.text)
        ...
        if self.ozoneSetpoint is None:
            ...
            if self.ozoneSetpoint == float32(0):
                self.ozoneSource = 'AUX_ECMWFT'
            else:
    ...
    def readTileMetadata(self):
        ...
        if self.ROI == 'AUTO':
            # check 1: international date line crossed?:
            self.ROI = 'OFF' # to avoid problems with functions below
            self.nrows = nrows
            self.ncols = ncols
            xy = self.get_geo_coordinates()
            lonMin, dummy, lonMax, dummy = self.get_lon_lat(xy)
            if lonMin < lonMax:
                self.ROI = 'AUTO' # reestablisg mode
            else:
                self.logger.stream('Auto detection is switched off as tile crosses the international date line.')
            if self.ROI == 'AUTO':
                # check 2: full tile detected?:
                if self.calc_region_of_interest() == 'OFF':
                    print
                    self.logger.stream('Auto detection is switched off as ROI is above 80% of full tile size.')
                    self.ROI = 'OFF'
            if self.ROI == 'AUTO':
                # continue in AUTO mode:
                scale = float(ncols / 1830.0)
                self.logger.info('ROI detection is performed in AUTO Mode.')
                rowTop, colLeft, rowBottom, colRight = self.get_region_of_interest()
                rowTop *= scale
                colLeft *= scale
                rowBottom *= scale
                colRight *= scale
                nrow_win = uint32(rint(rowBottom - rowTop))
                ncol_win = uint32(rint(colRight - colLeft))
                self.nrows = nrow_win
                self.ncols = ncol_win
        elif self.ROI == 'MANUAL':
            # ACIX campaign with fixed ROI:
            self.logger.stream('ROI detection is set to MANUAL mode via configuration.')
            top = 0
            left = 0
            bottom = nrows
            right = ncols
            scale = float(ncols / 10980.0)
            nrow_win = uint32(rint(self.nrow_win * scale))
            ncol_win = uint32(rint(self.ncol_win * scale))
            row0 = uint32(rint(self.row0 * scale))
            col0 = uint32(rint(self.col0 * scale))
            # self.nrows, ncols need to be uint32, otherwise masking_a3_skip1 in L2A_AtmCorr will fail!
            self.nrows = nrow_win
            self.ncols = ncol_win
            rowOffset = uint32(rint(nrow_win * 0.5))
            colOffset = uint32(rint(ncol_win * 0.5))
            rowTop = row0 - rowOffset
            rowBottom = row0 + rowOffset
            colLeft = col0 - colOffset
            colRight = col0 + colOffset
            ...
            self._rowTop = rowTop
            self._rowBottom = rowBottom
            self._colLeft = colLeft
            self._colRight = colRight
        ...
        if self.ROI == 'OFF':
            ...
            if (nrows < ncols):
                last_row = uint32(rint(solaz_arr[0].size * float(nrows) / float(ncols)))
                saa = solaz_arr[0:last_row, :]
                sza = solze_arr[0:last_row, :]
            elif (ncols < nrows):
                last_col = uint32(rint(solaz_arr[1].size * float(ncols) / float(nrows)))
            ...
            saa_row = float32(solaz_arr[0].size)
            saa_col = float32(solaz_arr[1].size)
            sza_row = float32(solze_arr[0].size)
            sza_col = float32(solze_arr[1].size)
            nrowsf = float32(nrows)
            ncolsf = float32(ncols)
            saa_rowsf = saa_row / nrowsf
            saa_colsf = saa_col / ncolsf
            sza_rowsf = sza_row / nrowsf
            sza_colsf = sza_col / ncolsf

            saa_rowTop = uint32(rint(float32(rowTop) * saa_rowsf))
            saa_rowBottom = uint32(rint(float32(rowBottom) * saa_rowsf))
            saa_colLeft = uint32(rint(float32(colLeft) * saa_colsf))
            saa_colRight = uint32(rint(float32(colRight) * saa_colsf))
            sza_rowTop = uint32(rint(float32(rowTop) * sza_rowsf))
            sza_rowBottom = uint32(rint(float32(rowBottom) * sza_rowsf))
            sza_colLeft = uint32(rint(float32(colLeft) * sza_colsf))
            sza_colRight = uint32(rint(float32(colRight) * sza_colsf))
            if saa_rowTop == saa_rowBottom and saa_colLeft == saa_colRight:
                # reduced array to single point due to test mode:
                saa = solaz_arr[saa_rowTop, saa_colLeft]
                sza = solze_arr[sza_rowTop, sza_colLeft]
            elif saa_rowTop == saa_rowBottom:
                saa = solaz_arr[saa_rowTop, saa_colLeft:saa_colRight]
                sza = solze_arr[sza_rowTop, sza_colLeft:sza_colRight]
            elif saa_colLeft == saa_colRight:
                saa = solaz_arr[saa_rowTop:saa_rowBottom, saa_colLeft]
                sza = solze_arr[sza_rowTop:sza_rowBottom, sza_colLeft]
            else:
                saa = solaz_arr[saa_rowTop:saa_rowBottom, saa_colLeft:saa_colRight]
                sza = solze_arr[sza_rowTop:sza_rowBottom,sza_colLeft:sza_colRight]
        ...
        try:
            ...
            tmp = float32(ang.Mean_Sun_Angle.ZENITH_ANGLE.text)
        except:
        ...
        self._solze_noclip = absolute(tmp)
        ...
        for i in range(arrlen):
            # implementation of SCOR-28, UMW:
            if viewAnglesList[i].AZIMUTH_ANGLE.text == 'NaN':
                self.logger.warning('mean azimuth angle[%d] is NaN' % i)
                self.logger.warning(
                    'No Mean_Viewing_Incidence_Angle values in tile metadata available, will be set to 0')
                vaa[i] = 0
                self.vaa_arr = array([0])
            else:
                vaa[i] = float32(viewAnglesList[i].AZIMUTH_ANGLE.text)
                self.vaa_arr = vaa[vaa > 0].mean()
            # implementation of SIIMPC-816-2, UMW:
            if viewAnglesList[i].ZENITH_ANGLE.text == 'NaN':
                self.logger.warning('mean zenith angle[%d] is NaN' % i)
                self.logger.warning(
                    'No Mean_Viewing_Incidence_Angle values in tile metadata available, will be set to 0')
                vza[i] = 0
                self.vza_arr = array([0])
            else:
                vza[i] = float32(viewAnglesList[i].ZENITH_ANGLE.text)
                self.vza_arr = vza[vza > 0].mean()
        return
    ...
    def setProductVersion(self):
        ...
        if self.operationMode == 'TOOLBOX':
            ...
            path = self.datastrip_root_folder
            if self.namingConvention == 'SAFE_STANDARD':
                filemask = 'S2?_????_MTD_L1C_DS_*.xml'
            else:
                filemask = 'MTD_DS.xml'
                ...
                for name in files:
                    ...
                    if (fnmatch.fnmatch(name, filemask) == True):
                        try:
                            ...
                            self.logger.warn(
                                '14.6 will be used by default, but warnings during validation might occur.\n')

        if self.operationMode != 'GENERATE_DATASTRIP':
            path = self._input_dir
            if self.namingConvention == 'SAFE_STANDARD':
                filemask = 'S2?_????_MTD_L1C_TL_*.xml'
            else:
                filemask = 'MTD_TL.xml'
            found = False
            for rt, dirs, files in os.walk(path):
        ...
        if self.operationMode != 'TOOLBOX':
            path = self.datastrip_root_folder
        if self.operationMode == 'GENERATE_DATASTRIP' and \
            ...
            for name in files:
                if (fnmatch.fnmatch(name, filemask) == True):
                    try:
                        ...
                        self.logger.warn('Processing_Info cannot be read.')
            if breaker:
                break

        if (productVersion == int(12)):
            self.logger.info('Sen2Cor ' + self.processorVersion + \
                ': Product version is below 14.6, will be converted to 14.6.')
            productVersion = float32(14.2)
        elif (productVersion == int(14)):
            xp = L2A_XmlParser(self, 'GIPP')
            node = xp.getNode('Common_Section')
            if node is None: self.parNotFound(node)
            PSD = node.PSD_Version.pyval
            if PSD != 'DEFAULT':
                productVersion = float32(PSD)
            else:
                if processingBaseline < float32(4.00):
                    productVersion = float32(14.6)
                # elif processingBaseline == float32(3.02):
                #     productVersion = float32(14.7)
                elif processingBaseline == float32(4.00):
                    productVersion = float32(14.9) 
                else:
                    self.logger.warn('Product versions > 14.9 are not implemented yet.')
                    self.logger.warn('Version 14.9 will be used by default, but warnings during validation might occur.\n')
                    productVersion = float32(14.9)
    ...
    def getDatatakeSensingStart(self):
        xp = L2A_XmlParser(self, 'DS2A')
        di = xp.getTree('General_Info', 'Datatake_Info')
        dsstxt = di.DATATAKE_SENSING_START.text
        if dsstxt:
            if '.' in dsstxt:
                dsstxt = dsstxt[:-5]
            else: # remove the Z:
    ...
    def calc_region_of_interest(self):
        # ROI is already determined:
        if self._rowTop != None:
            return 'AUTO'
        sys.stdout.write('ROI auto-detection is switched on, please wait: ')
        # UMW fix for S2MPC-1659: PDGS mode has no metadata file named MTD_TL.xml:
        # filepath = self.L1C_TILE_MTD_XML.replace('MTD_TL.xml', 'IMG_DATA')
        filepath = os.path.join(os.path.dirname(self.L1C_TILE_MTD_XML), 'IMG_DATA')
        test_full_tile = True
        for filename in sorted(glob.glob(os.path.join(filepath, '*_B??.jp2'))):
            indataset = glymur.Jp2k(filename)
            src_nrows = indataset.shape[0]
            src_ncols = indataset.shape[1]
            scale = float32(src_nrows / 1830.0)

            # next section to cancel ROI calculation, if a full tile is detected:
            if test_full_tile:
                corner_values = array([indataset[0,0], indataset[0,src_nrows-1], indataset[src_nrows-1,0], indataset[src_nrows-1,src_ncols-1]])
                if corner_values.min() > 0:
                    # this is a full tile, reset to normal processing:
                    return 'OFF'

            test_full_tile = False
            sys.stdout.write('.')
            roi = where(indataset[:] > 0)
            y1, x1 = amin(roi, axis=1)
            y2, x2 = amax(roi, axis=1)
            y1 = int16(rint(y1 / scale))
            x1 = int16(rint(x1 / scale))
            y2 = int16(rint(y2 / scale))
            x2 = int16(rint(x2 / scale))
            limit = int16(src_nrows / scale * 0.8)
            if y2-y1 > limit and x2-x1 > limit:
                return 'OFF'

            # expand ROI, if a band contains a broader area:
            if self._rowTop < y1:
                self._rowTop = y1
            if self._colLeft < x1:
                self._colLeft = x1
            ...
            if self._colRight < x2:
                self._colRight = x2
        print
        # store the ROI for the 10m processing:
        picFn = self.picFn
        logger = self.logger
        self.logger = None
        try:
    ...
    def set_mid_latitude_by_date(self):
        if self.midLatitude in ['SUMMER', 'WINTER']:
            return
        # else:
        xy = self.get_geo_coordinates()
        lonMin, latMin, lonMax, latMax = self.get_lon_lat(xy)
        lat_cen = int((latMax + latMin) / 2)
        doy_acq, isLeap = get_day_of_year(self.acquisitionDate)
        if not isLeap:
            Apr1 = 91  # 1. April
            Oct1 = 274  # 1. October
        else:
    ...
    def get_geo_coordinates(self):
        ...
        if self.ROI == 'AUTO': # scale according to resolution
            if self.resolution == 60:
                ...
                scale = 6
            yTop, xLeft, yBottom, xRight = self.get_region_of_interest()
            yTop *= scale
            xLeft *= scale
            yBottom *= scale
            xRight *= scale
            nrows = yBottom - yTop
            ncols = xRight - xLeft
        elif self.ROI == 'MANUAL':  # ROI is determined by configuration:
            top = 0
            left = 0
            if self.resolution == 60:
                bottom = 1830
            ...
            nrows = int(rint(self.nrow_win * scale))
            ncols = int(rint(self.ncol_win * scale))
            row0 = int(rint(self.row0 * scale))
            col0 = int(rint(self.col0 * scale))
        ...
        return asarray(extent)
    
    def get_lon_lat(self, xy):
        # get the target resolution and metadata for the resampled bands below:
        xp = L2A_XmlParser(self, 'T2A')
        tg = xp.getTree('Geometric_Info', 'Tile_Geocoding')
    ...
    def getMonth(self, dateStr):
        ...
        try:
            month = datetime.strptime(dateStr, '%Y-%m-%dT%H:%M:%SZ').timetuple().tm_mon
        except:    
            month = datetime.strptime(dateStr, '%Y-%m-%dT%H:%M:%S.%fZ').timetuple().tm_mon
